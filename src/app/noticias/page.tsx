  ...
  return (
    <main className="bg-background min-h-screen pt-24 selection:bg-primary selection:text-white">
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        {/* Placeholder dark background since we don't have a news image yet, using 'cielo.jpg' as fallback */}
      ...
      <section className="max-w-5xl mx-auto px-6 md:px-12 py-24 text-center">
        <div className="glass-panel-light p-12 rounded-[3rem] shadow-xl border border-black/5 inline-block">
          <span className="material-symbols-outlined text-6xl text-primary mb-6">campaign</span>
          ...
          <p className="font-body text-on-background-muted text-lg max-w-2xl mx-auto leading-relaxed">
            Estamos creando un portal de <strong>Noticias</strong> donde publicaremos las últimas novedades, eventos y actividades de nuestra institución. ¡Vuelve pronto!
          </p>
        </div>
      </section>
    </main>
